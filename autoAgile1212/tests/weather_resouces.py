  ...
  "test_cases": [
    {
      "requirement": "Search",
      "test_case_1": {
        "description": "Search for an agent by typing a fragment of their name",
        "input": "Agent name fragment",
        "expected_output": "List of agents matching the search criteria"
      },
      "test_case_2": {
        "description": "Search for an agent by typing a fragment of their designation",
        "input": "Agent designation fragment",
        "expected_output": "List of agents matching the search criteria"
      },
      "test_case_3": {
        "description": "Search for an agent by typing a fragment of their city",
        "input": "Agent city fragment",
        "expected_output": "List of agents matching the search criteria"
      }
    },
    {
      ...
      "test_case_1": {
        ...
        "input": "Valid Agent ID and password",
        "expected_output": "Successful login"
      },
      "test_case_2": {
        "description": "Login with invalid credentials",
        "input": "Invalid Agent ID and password",
        "expected_output": "Login failure"
      },
      "test_case_3": {
        "description": "Sign up with valid details",
        "input": "Agent ID, email, password",
        "expected_output": "Successful account creation"
      }
    },
    {
      "requirement": "Profile Page",
      "test_case_1": {
        "description": "View comprehensive information of an agent",
        "input": "Tap on an agent in search results",
        "expected_output": "Display detailed profile page of the agent"
      }
    },
    {
      "requirement": "Events Navigation",
      "test_case_1": {
        "description": "Navigate through different types of events",
        "input": "Tap on events tab",
        "expected_output": "Display list of event categories"
      },
      "test_case_2": {
        "description": "View details of a specific event",
        "input": "Tap on a specific event",
        "expected_output": "Display detailed information about the event"
      }
    },
    {
      "requirement": "Branches Navigation",
      "test_case_1": {
        "description": "Navigate through different branches",
        "input": "Tap on branches tab",
        "expected_output": "Display list of branches"
      },
      "test_case_2": {
        "description": "View details of a specific branch",
        "input": "Tap on a specific branch",
        "expected_output": "Display detailed information about the branch"
      }
    }
  ]
}
